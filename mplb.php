...
$query = "SELECT * FROM tb_nilai WHERE jurusan = 'MPLB'ORDER BY nama ASC";
...
<head>
    ...
    <title>Data Nilai Siswa - MPLB</title>
...
<body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-custom">
            <div class="container-fluid">
                <a class="navbar-brand">Aplikasi Data Nilai Siswa - MPLB</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
      <ul class="navbar-nav">
        ...
        <div class="mt-4">
            <h2>Daftar Nilai Siswa - MPLB</h2>
            <a href="olah_mplb.php" type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
            </svg>Tambah</a>
             <form method="get" action="hasilmplb.php" class="mb-3">
